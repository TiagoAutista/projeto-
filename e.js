// src/ui/menu.js
// Na função mostrarMenu(), adicione:
...
async function mostrarMenu(rl) {
  ...
  console.log('║  [9] SDU - Buscar ID Fibra              ║'); // ✅ NOVO
  console.log('║  [10] SDU - Inspeção/Ajustes Manuais    ║'); // ✅ NOVO
  console.log('║  [0] Encerrar                            ║');
  console.log('╚══════════════════════════════════════════╝');
  
  // ... resto do código (ajuste para aceitar "10" e "0")
}
